...
Have students open the Scaling Exploration teachpack and investigate with their partner, using the workbook as a guide. @worksheet-link{exercises/intro-to-dilations-wb1.adoc, Link to Workbook Page}
