...
To wrap up the discussion, emphasize that all the figures are cubes that have had some element of their appearance altered, whether it's the position on the table, the angle it's sitting at, its color, or its size.  However, they're all still cubes.
...
Have students open the Scaling Exploration teachpack and investigate with their partner, using the workbook as a guide. @worksheet-link{pathwayJ, intro-to-dilations, exercises/intro-to-dilations-wb1.adoc}
